...
def main():
    ...
    publisher = MqttPub(monitor, args.dst_mqtt_server, args.dst_mqtt_port, args.topic, MQTT_QOS,
    ...
    subscriber = MqttSub(monitor, args.src_mqtt_server, args.src_mqtt_port, args.topic, MQTT_QOS, on_message,
