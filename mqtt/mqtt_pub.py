...
class MqttPub(MqttClient):
    def __init__(self, monitor, mqtt_server, mqtt_port, mqtt_username, mqtt_password, topic, qos, timeout=5):
        super().__init__(monitor, mqtt_server, mqtt_port, mqtt_username, mqtt_password, topic)
